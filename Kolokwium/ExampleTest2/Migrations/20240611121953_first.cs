    ...
    public partial class first : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 20, "Jan", "Kowalski", 50 },
                    { 2, 15, "Janina", "Kowalska", 80 },
                    { 3, 30, "Joana", "Kowalska", 90 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2, new DateTime(9999, 12, 31, 23, 59, 59, 999, DateTimeKind.Unspecified).AddTicks(9999) },
                    { 3, 3, new DateTime(2024, 6, 11, 14, 19, 52, 958, DateTimeKind.Local).AddTicks(8086) }
                });
